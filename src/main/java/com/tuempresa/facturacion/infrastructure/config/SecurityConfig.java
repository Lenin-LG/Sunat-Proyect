...
public class SecurityConfig {
    ...
    @Bean
    public UserDetailsService userDetailsService(UsuarioPersistencePort usuarioPersistencePort) {
        return username -> usuarioPersistencePort.findByUsername(username)
                .map(u -> new User(
                        u.getUsername(),
                        u.getPassword(),
